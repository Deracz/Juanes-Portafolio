// Archivo independiente de traducciones para cambio de idioma.
window.translations = {
    es: {
        brand: 'Juan Oviedo',
        nav: {
        ...
        projects: {
            tag: 'Proyectos',
            title: 'Experiencias con enfoque técnico y real.',
            items: [
                {
                    title: 'Sierra Dorada',
                    desc: 'E-commerce artesanal para cerveza con operaciones CRUD y gestión administrativa.'
                },
                {
                    title: 'NASA APOD API',
                    desc: 'Consumo de una API pública usando Fetch y JavaScript asíncrono.'
                },
                {
                    title: 'Hackathon Project',
                    desc: 'Proyecto colaborativo desarrollado durante el hackathon de Generation.'
                },
                {
                    title: 'Web Storage Lab',
                    desc: 'Implementación de LocalStorage y SessionStorage para persistencia de datos.'
                }
            ]
        },
        experience: {
            ...
            companies: [
                ...
                { name: 'Generation Colombia', role: 'Java Full Stack Trainee' }
            ]
        },
        reflection: {
            tag: 'Reflexión',
        ...
        stats: {
            ...
            technologies: 'Tecnologías aprendidas',
    ...
    en: {
        ...
        projects: {
            tag: 'Projects',
            title: 'Hands-on experiences with real technical focus.',
            items: [
                {
                    title: 'Sierra Dorada',
                    desc: 'Artisan beer e-commerce platform with CRUD operations and admin management.'
                },
                {
                    title: 'NASA APOD API',
                    desc: 'Public API consumption using Fetch and async JavaScript.'
                },
                {
                    title: 'Hackathon Project',
                    desc: 'Collaborative project developed during the Generation hackathon.'
                },
                {
                    title: 'Web Storage Lab',
                    desc: 'Implementation of LocalStorage and SessionStorage for data persistence.'
                }
            ]
        },
        experience: {
